...
var SuperHeroesComponent = (function (_super) {
    ...
    SuperHeroesComponent.prototype.onClick = function (superHero) {
        this.describePowers(superHero.powers);
    };
    SuperHeroesComponent.prototype.describePowers = function (heroPowers) {
        if (heroPowers.length) {
            alert(heroPowers.map(function (power) { return power; }));
        }
        else {
            alert('Unknown');
        }
